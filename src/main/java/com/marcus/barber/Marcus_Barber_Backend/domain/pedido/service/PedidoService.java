...
public class PedidoService {
    ...
    @CacheEvict(value = "LISTAR_PEDIDOS", allEntries = true)
    public DatosPedido CrearPedido(CrearPedido crearPedido) {
        ...
        DatosPedido datosPedido = new DatosPedido(pedido, listaDetallesPedido);

        cacheManager.getCache("PEDIDO").put("PEDIDO_" + pedido.getId(), datosPedido);

        return datosPedido;

    }

    @Cacheable(value = "LISTAR_PEDIDOS", key = "#pageable.pageNumber")
    ...
    @CachePut(value = "PEDIDO", key = "'PEDIDO_' + #id")
    @CacheEvict(value = "LISTAR_PEDIDOS", allEntries = true)
    ...
    @Cacheable(value = "PEDIDO", key = "'PEDIDO_' + #id")
